...
using Task = TaskWebApi.Services.Models.Task;
...
namespace TaskWebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            work = new UnitOfWork();
            _aspnetUserRepository = work.Repository<AspNetUser>();
            _aspnetRoleRepository = work.Repository<AspNetRole>();
            _taskRepository = work.Repository<Task>();
        }
